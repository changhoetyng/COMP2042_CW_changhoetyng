...
public class Animal extends Actor {
	...
	public Animal(String imageLink) {
		...
		setX(300);
		setY(679.8+movement);
		imgW1 = new Image("file:src/Pictures/froggerUp.png", imgSize, imgSize, true, true);
		imgA1 = new Image("file:src/Pictures/froggerLeft.png", imgSize, imgSize, true, true);
		imgS1 = new Image("file:src/Pictures/froggerDown.png", imgSize, imgSize, true, true);
		imgD1 = new Image("file:src/Pictures/froggerRight.png", imgSize, imgSize, true, true);
		imgW2 = new Image("file:src/Pictures/froggerUpJump.png", imgSize, imgSize, true, true);
		imgA2 = new Image("file:src/Pictures/froggerLeftJump.png", imgSize, imgSize, true, true);
		imgS2 = new Image("file:src/Pictures/froggerDownJump.png", imgSize, imgSize, true, true);
		imgD2 = new Image("file:src/Pictures/froggerRightJump.png", imgSize, imgSize, true, true);
